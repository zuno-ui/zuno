...
export const meta: ComponentMeta[] = [
  {
    ...
    accessibility: ["Use text that describes the action. With size=\"icon\" or an icon-only button, provide an aria-label.", "loading exposes aria-busy, prevents duplicate submissions and keeps the button width; the spinner respects prefers-reduced-motion.", "For navigation, pass an anchor or framework link to render; it keeps link semantics. Set type=\"submit\" for form actions."],
    ...
    examples: [
      { id: "button-variants", title: "Action hierarchy", description: "From primary emphasis to a text-style action, each variant brings order to the interface.", code: '<Button>Save</Button>\n<Button variant="secondary">Duplicate</Button>\n<Button variant="outline">Cancel</Button>\n<Button variant="ghost">Discard</Button>\n<Button variant="destructive">Delete</Button>\n<Button variant="link">Show details</Button>' },
      { id: "button-as-link", title: "Navigation stays a link", description: "An anchor can look like a button while retaining link semantics and browser navigation.", code: '<Button render={<a href="/docs" />}>Read documentation</Button>' },
